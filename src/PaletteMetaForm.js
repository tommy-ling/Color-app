...
export default function PaletteMetaForm(props) {
  const { colors, formShowing, setFormShowing, newPaletteName, setNewPaletteName } = React.useContext(NewPaletteFormContext)
  const { history, savePalette, palettes } = props
